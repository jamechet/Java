...
public class GameOverScreen implements Screen {
    ...
    public GameOverScreen(GameCore game) {
        this.game = game;
    ...
    public void render(float f) {
        ...
        lifeFont.draw(scoreBatch, " GAME OVER" , Gdx.graphics.getWidth() / 2 - 70f, Gdx.graphics.getHeight() / 2 + 200f);
        scoreBatch.end();
    }
