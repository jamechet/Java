 ...
 */
public class Player3 implements Runnable, KeyListener {
    ...
    public Buffer<String> playerThreeMessages = new Buffer<String>(10);
 	//Player01
    ...
    public Player3(Server parentServer){
    ...
    public synchronized void cycleMessages(String message){
    	...
    	try {
    		if(playerThreeMessages.count > 0){
    			System.out.println(playerThreeMessages.get());
    		}
    		
			playerThreeMessages.put(message);
	...
	public synchronized void updateDirection() throws InterruptedException{
		...
		currentServer.playerThreeMoves.put(direction);				
	}
