 ...
 */
public class Player1 implements Runnable, KeyListener {
    ...
    public Buffer<String> playerOneMessages = new Buffer<String>(10);
 	//Player01
    ...
    public Player1(Server parentServer){
    ...
    public synchronized void cycleMessages(String message){
    	...
    	try {
    		if(playerOneMessages.count > 0){
    			System.out.println(playerOneMessages.get());
    		}
    		
			playerOneMessages.put(message);
	...
	public synchronized void updateDirection() throws InterruptedException{
		...
		currentServer.playerOneMoves.put(direction);				
	}
