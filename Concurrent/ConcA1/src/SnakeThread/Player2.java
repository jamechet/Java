 ...
 */
public class Player2 implements Runnable, KeyListener {
    ...
    public Buffer<String> playerTwoMessages = new Buffer<String>(10);
 	//Player01
    ...
    public Player2(Server parentServer){
    ...
    public synchronized void cycleMessages(String message){
    	...
    	try {
    		if(playerTwoMessages.count > 0){
    			System.out.println(playerTwoMessages.get());
    		}
    		
			playerTwoMessages.put(message);
	...
	public synchronized void updateDirection() throws InterruptedException{
		...
		currentServer.playerTwoMoves.put(direction);				
	}
